...
namespace Clara.Migrations
{
    ...
    [Migration("20201202075822_ChangedExpectedGuestDataTypeToInt")]
    partial class ChangedExpectedGuestDataTypeToInt
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Clara.Models.Booking", b =>
                {
            ...
            modelBuilder.Entity("Clara.Models.UserProfile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "1a2d2414-3baa-473b-baf2-0a3dd5e6a6e2",
                            Email = "Test@mail.com",
                            FirstName = "Just",
                            LastName = "Test"
                        });
            ...
            modelBuilder.Entity("Clara.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1a2d2414-3baa-473b-baf2-0a3dd5e6a6e2",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ce61d808-7b38-47c3-b864-2d9e8dfdf235",
                            Email = "Test@mail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedUserName = "Test@mail.com",
                            PasswordHash = "AQAAAAEAACcQAAAAEFTmqATQKex9hCJ9A/1/0GS9UEjNR/+4tgVNNeo1M83p0U2MwQvCHT9iVW1sJ0TU8w==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "f1bd7117-ce3f-4722-9208-cd4a691ed82c",
            ...
            modelBuilder.Entity("Clara.Models.Service", b =>
                {
                    ...
                    b.HasOne("Clara.Models.UserProfile", "UserProfile")
                        .WithMany("Services")
